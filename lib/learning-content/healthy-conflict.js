...
export const HEALTHY_CONFLICT_SERIES = {
  ...
  icon: "conflict",
  color: "#8b5cf6",
  image: "/images/healthy-conflict-01.jpg",
  totalDurationMin: 35,
  chapterCount: 7,
  ...
  chapters: [
    ...
    // =========================================================================
    {
      ...
      activity: {
        ...
        config: {
          ...
          scenario: {
            initialMessage: "Stell dir vor, du möchtest ein schwieriges Thema ansprechen – zum Beispiel: dein Partner ist oft am Handy, ihr verbringt zu wenig Zeit zusammen, oder du fühlst dich mit dem Haushalt allein.\n\nWie würdest du das Gespräch beginnen? Versuch es mit der Struktur:\n\n\"Ich fühle mich... wenn... Ich wünsche mir...\"",
      ...
      activity: {
        ...
        config: {
          steps: [
            {
              id: "signal",
              title: "Mein Pause-Signal",
              subtitle: "Wie zeigst du, dass du eine Pause brauchst?",
              summaryLabel: "Signal",
              options: [
                { id: "hand", label: "✋ Handzeichen" },
                { id: "word", label: "💬 Codewort (z.B. \"Timeout\")" },
                { id: "sentence", label: "📝 \"Ich brauche kurz Luft\"" },
              ],
            },
            {
              id: "duration",
              title: "Meine Pause-Dauer",
              subtitle: "Wie lange brauchst du meistens?",
              summaryLabel: "Dauer",
              options: [
            ...
            {
              id: "activity",
              title: "Was beruhigt mich?",
              subtitle: "Was hilft dir, dich zu regulieren?",
              summaryLabel: "Aktivität",
              options: [
                { id: "walk", label: "🚶 Spazieren gehen" },
                { id: "music", label: "🎵 Musik hören" },
                { id: "breathe", label: "🧘 Atmen / Meditation" },
                { id: "water", label: "💧 Wasser, frische Luft" },
                { id: "alone", label: "🛋️ Einfach allein sein" },
              ],
            },
            {
              id: "return",
              title: "Mein Rückkehr-Ritual",
              subtitle: "Wie möchtest du zurückkommen?",
              summaryLabel: "Rückkehr",
              options: [
                { id: "touch", label: "🤗 Mit einer Umarmung" },
                { id: "check", label: "💬 \"Bist du bereit?\"" },
                { id: "tea", label: "☕ Mit Tee/Kaffee" },
                { id: "sit", label: "🛋️ Einfach hinsetzen" },
              ],
            },
          ],
        },
    ...
    // =========================================================================
    {
      ...
      activity: {
        ...
        config: {
          ...
          scenario: {
            initialMessage: "Ich spiele jetzt deinen Partner und erzähle dir etwas. Versuch, validierend zu antworten – ohne sofort zu lösen oder zu bewerten.\n\n\"Ich hatte heute so einen stressigen Tag. Mein Chef hat wieder alles auf mich abgeladen und ich fühl mich einfach überfordert.\"",
            inputPlaceholder: "Deine validierende Antwort...",
            context: "Der User übt Validation. Amiya spielt den Partner und gibt Feedback ob die Antwort validierend war (Gefühle anerkennen, nicht lösen).",
          },
          maxTurns: 4,
        },
      },
          ...
          sections: [
            {
              ...
              subtitle: "Wähle alle die passen",
              type: "multiselect",
              options: [
            ...
            },
            {
              ...
              subtitle: "Denk an Momente wo ihr euch wieder gefunden habt",
              type: "text",
            ...
            },
            {
              ...
              subtitle: "Was hat schon mal richtig gut funktioniert?",
              type: "text",
              placeholder: "Beschreibe einen Moment wo ihr euch versöhnt habt...",
            },
          ],
        },
      },
    ...
    // =========================================================================
    {
      ...
      activity: {
        ...
        subtitle: "Deine persönliche Reflexion",
        config: {
          title: "Welche Regeln sind DIR wichtig?",
          subtitle: "Wähle die Punkte die du in Konflikten einhalten möchtest",
          options: [
            {
              id: "no_insults",
              label: "Keine Beleidigungen",
              description: "Auch wenn ich wütend bin – persönliche Angriffe sind tabu.",
            },
            {
              id: "pauses_allowed",
              label: "Pausen sind erlaubt",
              description: "Ich darf eine Pause nehmen, wenn es zu viel wird.",
            },
            {
              id: "no_bedtime",
            ...
            {
              id: "one_speaks",
              label: "Erst zuhören, dann antworten",
              description: "Nicht unterbrechen – wirklich verstehen wollen.",
            },
            {
              id: "stay_on_topic",
