      ...
      activity: {
        ...
        config: {
          questions: [
            {
              id: "q1",
              text: "\"Du hörst mir nie zu! Du bist immer nur mit dir selbst beschäftigt!\"",
              correctAnswer: "kritik",
              options: [
                { id: "kritik", label: "Kritik", emoji: "⚔️" },
                { id: "verteidigung", label: "Verteidigung", emoji: "🛡️" },
                { id: "verachtung", label: "Verachtung", emoji: "🙄" },
                { id: "mauern", label: "Mauern", emoji: "🧱" },
              ],
              feedback: {
                correct: "Genau! Das ist Kritik – ein Vorwurf an die ganze Person statt an ein konkretes Verhalten.",
                incorrect: "Das ist Kritik – \"nie\" und \"immer\" sind typische Anzeichen für einen Vorwurf an die Person.",
              },
            },
            {
              id: "q2",
              text: "\"Das stimmt überhaupt nicht! Du vergisst, dass ich letzte Woche schon...\"",
              correctAnswer: "verteidigung",
              options: [
                { id: "kritik", label: "Kritik", emoji: "⚔️" },
                { id: "verteidigung", label: "Verteidigung", emoji: "🛡️" },
                { id: "verachtung", label: "Verachtung", emoji: "🙄" },
              ...
              feedback: {
                correct: "Richtig! Das ist Verteidigung – sofort erklären statt zuhören.",
                incorrect: "Das ist Verteidigung – die Person wehrt sich sofort, statt erst zuzuhören.",
              },
            },
            {
              id: "q3",
              text: "*Augenrollen* \"Na klar, du bist ja auch sooo perfekt...\"",
              correctAnswer: "verachtung",
              options: [
                { id: "kritik", label: "Kritik", emoji: "⚔️" },
                { id: "verteidigung", label: "Verteidigung", emoji: "🛡️" },
                { id: "verachtung", label: "Verachtung", emoji: "🙄" },
              ...
              feedback: {
                correct: "Genau! Augenrollen und Sarkasmus sind typische Zeichen für Verachtung.",
                incorrect: "Das ist Verachtung – Augenrollen und Sarkasmus zeigen aufgestauten Frust.",
              },
            },
            {
              id: "q4",
              text: "*Schweigen. Blick abwenden. Innerlich abschalten.*",
              correctAnswer: "mauern",
              options: [
                { id: "kritik", label: "Kritik", emoji: "⚔️" },
                { id: "verteidigung", label: "Verteidigung", emoji: "🛡️" },
                { id: "verachtung", label: "Verachtung", emoji: "🙄" },
              ...
              feedback: {
                correct: "Richtig! Mauern ist der Rückzug – oft ein Zeichen dass alles zu viel ist.",
                incorrect: "Das ist Mauern – sich zurückziehen und abschalten, wenn es zu viel wird.",
              },
            },
            {
              id: "q5",
              text: "\"Typisch! Du machst das absichtlich um mich zu ärgern.\"",
              correctAnswer: "kritik",
              options: [
                { id: "kritik", label: "Kritik", emoji: "⚔️" },
                { id: "verteidigung", label: "Verteidigung", emoji: "🛡️" },
              ...
              feedback: {
                correct: "Richtig! \"Typisch\" und Unterstellungen zur Absicht sind Kritik.",
                incorrect: "Das ist Kritik – der Person wird eine negative Absicht unterstellt.",
              },
            },
          ],
          showScore: true,
