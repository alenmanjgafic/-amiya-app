...
function buildTokens(colors, isDark) {
  ...
  const gradients = {
    // Primary action gradient (buttons, CTAs) - lavender → rose
    primary: `linear-gradient(135deg, ${colors.aurora.lavender}, ${colors.aurora.rose})`,
    primaryHorizontal: `linear-gradient(90deg, ${colors.aurora.lavender}, ${colors.aurora.rose})`,

    // Subtle surface gradients (card backgrounds, highlights)
    surface: `linear-gradient(135deg, ${colors.aurora.lavender}20, ${colors.aurora.rose}20)`,
    surfaceLight: `linear-gradient(135deg, ${colors.aurora.lavender}10, ${colors.aurora.rose}10)`,
    surfaceSubtle: `linear-gradient(135deg, ${colors.aurora.lavender}15, ${colors.aurora.rose}10)`,

    // Mint accent gradient (secondary actions, progress)
